...
\end{theorem}
\begin{proof}
% should mostly be straightforward
\end{proof}
...
Note: Instead of defining phi explicitly, we can also defined multiplication of fibers directly in terms of representatives from the fibers.
...
\end{theorem}
\begin{proof}
% hey we were arguing about this earlier
\end{proof}

% then like 6 more pages I'll be back ok
